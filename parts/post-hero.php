...
?>
<section class="is-layout-constrained wp-block-group alignfull has-green-40-white-background-color
    has-background" id="hero">
        ...
        <section class="wp-block-columns alignwide">
            ...
            <div class="is-layout-flow wp-block-column" style="flex-basis:40%">
                <figure class="wp-block-post-featured-image">
                    <img class="wp-block-image" alt="hello" src="<?php echo $args['post_thumbnail']  ?>" />
                </figure>
            </div>
        </section>
    <?php else : ?>
